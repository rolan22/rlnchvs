            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        ...
                        cl.sendText(msg.to,"DI HAPUS NJING")
                        ki.sendText(msg.to,"DI HAPUS NJING")
                        kk.sendText(msg.to,"DI HAPUS NJING")
                        kc.sendText(msg.to,"DI HAPUS NJING")
                        wait["dblack"] = False

                   else:
                        wait["dblack"] = False
                        cl.sendText(msg.to,"GAK ADA DI DAFTAR HITAM SU")
                        ki.sendText(msg.to,"GAK ADA DI DAFTAR HITAM SU")
                        kk.sendText(msg.to,"GAK ADA DI DAFTAR HITAM SU")
                        kc.sendText(msg.to,"GAK ADA DI DAFTAR HITAM SU")
               elif wait["wblacklist"] == True:
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        cl.sendText(msg.to,"DONE YA SU")
                        ki.sendText(msg.to,"DONE YA SU")
                        kk.sendText(msg.to,"DONE YA SU")
                        kc.sendText(msg.to,"DONE YA SU")
